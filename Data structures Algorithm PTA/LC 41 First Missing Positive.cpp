 ...
 *    3) during the removing process, if some number cannot be found, which means it's missed.
 *
...
int firstMissingPositive(int A[], int n) 
{
	...
	//---这个是什么意思啊？rand()%2如果为真就return move，如果为假就return map
	if (rand() % 2) 
	{
...
void Test(int a[], int n, int expected) 
{
	...
	cout << "\t   missed = " << ret << "  " 
		<< (ret == expected ? "passed!" : "failed!") << endl;
}
